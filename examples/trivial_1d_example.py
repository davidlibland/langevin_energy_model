...
X = pd.DataFrame(np.random.normal(5, 1, (10000, 1)))
X
...
clf = EnergyModel(
    ...
    sampler_lr=1e-3,
    prior_scale=3,
    adversary_weight=0.7,
    max_replay=3,
    num_sample_mc_steps=1000,
    sampler_beta_min=0.02,
    sampler_beta_target=1,
    ais_num_chains=1000,
    ais_num_interpolants=100,
    ais_max_interpolants=1000
)
max_resources = 30
if do_search == "halving":
    ...
    distributions.add_hyperparameter(CSH.UniformIntegerHyperparameter("num_units", 4, 16, default_value=16))
