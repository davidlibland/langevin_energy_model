...
def visual_test_sample_fantasy_(fig, num_layers=2, num_units=2, num_steps=10, num_mc_steps=100, num_chains=10, lr=1e-3, sigma=1, net=None):
    fig.clear()
    ax = fig.subplots(1, 1)
    if net is None:
        net = SimpleEnergyModel(num_inputs=1, num_layers=num_layers, num_units=num_units)
